...
contract('MikeCoin', function (accounts) {
  ...
  it('creation: should create an initial balance of 10000 for the creator', function () {
    console.log("Test Being Run!")
    MikeCoin.new(10000, 'MikeCoins', 1, 'MC', {from: accounts[0]}).then(function (ctr) {
  ...
  it('creation: test correct setting of vanity information', function () {
    var ctr
    console.log(MikeCoin)
    return MikeCoin.new(10000, 'MikeCoins', 1, 'MC', {from: accounts[0]}).then(function (result) {
      ctr = result
      ...
      assert.strictEqual(result, 'MC')
    }).catch((err) => { throw new Error(err) })
  })

  it('creation: should succeed in creating over 2^256 - 1 (max) tokens', function () {
    // 2^256 - 1
    return MikeCoin.new('115792089237316195423570985008687907853269984665640564039457584007913129639935', 'MikeCoins', 1, 'MC', {from: accounts[0]}).then(function (ctr) {
...
//     var ctr = null
//     return MikeCoin.new(10000, 'MikeCoins', 1, 'MC', {from: accounts[0]})
//     .then(function (result) {
//       ctr = result
